          ...
          <main>
            ...
            <section>
              ...
              <input
                ...
                placeholder="Idade do obituário"
              />
              <p>Idade: {idade}</p>
            </section>
            ...
            <section>
              ...
              <input
                ...
                name="fname"
                value={citybairro}
                onChange={(e) => setCityBairro(e.target.value)}
              />
              ...
              <input
                ...
                name="fname"
                value={cityrua}
                onChange={(e) => setCityRua(e.target.value)}
              />
              <p>Rua: {cityrua}</p>
            </section>
            ...
            <fieldset>
              <section>
                ...
                <textarea
                  ...
                  cols="38"
                  rows="10"
                  placeholder="Faça suas observações"
                  fname="observation"
                ></textarea>
              </section>
            </fieldset>
